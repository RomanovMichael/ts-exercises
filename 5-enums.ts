...
// Реализуйте функцию buildModal(). 
// Он возвращает объект, который описывает модальное окно. 
...
const buildModal = (text: string, status: ModalStatus): {text: string, status: ModalStatus} => ({text, status })